...
import { authInstance } from '../firebaseConfig'; // Note the path change to ../
...
export default function SettingsPage() {
  ...
  const handleNotifications = () => Alert.alert('Notifications', 'Functionality to be implemented.');
  const handlePrivacyPolicy = () => Alert.alert('Privacy Policy', 'Functionality to be implemented.');
    ...
    <SafeAreaView style={styles.screenContainer}>
      ...
      <ScrollView>
        <View style={styles.card}>
          ...
          <View style={styles.separator} />
          <SettingsItem icon={<Bell size={24} color={THEME.text} />} text="Notifications" onPress={handleNotifications} />
          <View style={styles.separator} />
          <SettingsItem icon={<Info size={24} color={THEME.text} />} text="About Namsadhan" onPress={handleAbout} />
          <View style={styles.separator} />
          <SettingsItem icon={<Shield size={24} color={THEME.text} />} text="Privacy Policy" onPress={handlePrivacyPolicy} />
        </View>

        <View style={[styles.card, { marginTop: 20 }]}>
          <SettingsItem icon={<LogOut size={24} color={THEME.error} />} text="Sign Out" onPress={handleSignOut} />
        </View>
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <TouchableOpacity style={styles.contactButton} onPress={handleMap}>
                ...
                <Text style={styles.contactText}>Ashram Location</Text>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  contactButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 15, width: '100%', paddingHorizontal: 10 },
