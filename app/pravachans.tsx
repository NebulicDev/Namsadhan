...
import { ChevronLeft, Mic2, Pause, Play } from 'lucide-react-native';
...
// --- Pravachans Data ---
// TODO: Add your actual audio files here
  ...
  const TrackItem = ({ item }: { item: any }) => {
    ...
    return (
      <View style={styles.card}>
        <View style={styles.iconContainer}><Mic2 size={28} color={THEME.primary} /></View>
